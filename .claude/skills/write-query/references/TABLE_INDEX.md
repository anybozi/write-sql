...
| 013 | 全业务资料表 | ads_yz_tb_comm_cm_all_final | dwm_yz_tb_comm_cm_all_final；dwm_yz_tb_comm_cm_all_mon_final | tables/013_全业务资料表.md | 以 serv_id 为服务粒度；账期/统计月份一般为 par_month_id | par_month_id | 近半年账期优先日表，更早历史走月表，重叠默认日表 | 订单动作用 040/041；收入用 047/048 |
...
| 069 | 全业务资料表 | ads_yz_tb_comm_cm_all_final | dwm_yz_tb_comm_cm_all_final | tables/069_全业务资料表.md | 以 serv_id 为服务粒度；账期/统计月份一般为 par_month_id | par_month_id | 入网/到达/在网/出账等全业务规模默认主表 | 订单动作用 040/041；收入用 047/048/117 |
